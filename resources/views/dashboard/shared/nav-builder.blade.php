...
?>
      ...
      <div class="c-sidebar-brand"><img class="c-sidebar-brand-full" src="{{ env('APP_URL', '') }}/assets/brand/coreui-base-white.svg1" width="118" height="46" alt="WMI Logo"><img class="c-sidebar-brand-minimized" src="assets/brand/coreui-signet-white.svg1" width="118" height="46" alt="WMI Logo"></div>
